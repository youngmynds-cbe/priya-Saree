...
const Landing = () => {
  ...
  <span
                  ...
                  {/* Title */}
                  <h3 className="text-[26px] font-[gabriola] text-gray-900 mb-3 leading-snug group-hover:text-purple-700 transition-colors">
                    {post.title}
                  </h3>

                  <p className="text-gray-600  font-[readexPro] text-[16px] leading-relaxed mb-4">
                    {post.excerpt}
                  </p>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-[14px]  text-gray-700 font-[readexPro]">
                        {post.author.name}
                      </span>
                    </div>
                    <span className="text-[14px]  text-gray-500 font-[readexPro]">{post.date}</span>
                  </div>

                  {/* Read More Link */}
                  <button className="flex items-center gap-2 text-[14px] text-purple-700 font-[readexPro] text-sm group-hover:gap-3 transition-all">
                    Read More
