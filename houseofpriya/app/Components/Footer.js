        ...
        "
                  ...
                  <address className="not-italic">
                    <ul className="space-y-5 font-readex text-[16px] sm:text-[18px]">
                      ...
                      <li className="flex justify-center lg:justify-start items-center gap-3">
                        <img src="/images/Vector (2).png" alt="Email icon" className="w-5 h-5" />
                      ...
                      <li className="flex justify-center lg:justify-start items-center gap-3">
                        <img src="/images/phone-line.png" alt="Phone icon" className="w-5 h-5" />
        ...
        flex flex-col md:flex-row justify-between items-center gap-4"
            >
              <p className="font-['DM_Sans'] text-[13px] sm:text-[14px]">
                Made with by{" "}
                <a href="https://wa.me/919363167299?text=Hi%20young%20mynds.%20I%20am%20interested%20in%20your%20service." target="_blank"
    rel="noopener noreferrer">
