        ...
        "
                >
                  <img
                    ...
                    className="w-full h-[500px] md:h-[700px]  lg:h-[660px] object-contain"
                    alt="Saree Model"
                  />
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center px-6">
            ...
            <div className="text-left">
              ...
              <p className="mt-8 text-[16px] leading-[26px] tracking-[0.2px]   font-readex text-[#7A7A7A] max-w-md">
                House of Priya was born from a deep love for sarees and the
                belief that every woman deserves to feel confident, graceful,
              ...
              <p className="mt-5 text-[16px] leading-[26px] tracking-[0.2px] font-readex text-[#7A7A7A] max-w-md">
                ...
                craftsmanship with contemporary design sensibilities – making
                them perfect for both everyday elegance and special occasions.
              </p>
    ...
    "
        ...
        <section className="bg-white py-20">
          <div className="max-w-7xl mx-auto px-3">
            {/* SECTION TITLE */}
            <h2 className="-mt-25 lg:mt-0 md:mt-0 sm:mt-0 text-center font-gabriola text-[28px] lg:text-[48px] md:text-[38px] leading-[52px] tracking-[-0.3px] text-[#5B2D8B]">
            ...
            <div className="mt-16 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="border border-gray-100 rounded-2xl p-5 lg:p-8 text-center shadow-sm hover:shadow-md transition">
                <div className="w-15 h-12 mx-auto rounded-full bg-purple-100 flex items-center justify-center">
                  <img src="../images/div (2).png" alt="" aria-hidden="true" />
                </div>
              ...
              <div className="border border-gray-100 rounded-2xl p-5 lg:p-8 text-center shadow-sm hover:shadow-md transition">
                <div className="w-12 h-12 mx-auto rounded-full bg-purple-100 flex items-center justify-center">
                  <img src="../images/div (3).png" alt="" aria-hidden="true" />
                </div>
              ...
              <div className="border border-gray-100 rounded-2xl p-5 lg:p-8 text-center shadow-sm hover:shadow-md transition">
                <div className="w-12 h-12 mx-auto rounded-full bg-purple-100 flex items-center justify-center">
                  <img src="../images/div (4).png" alt="" aria-hidden="true" />
                </div>
              ...
              <div className="border border-gray-100 rounded-2xl p-5 lg:p-8 text-center shadow-sm hover:shadow-md transition">
                <div className="w-12 h-12 mx-auto rounded-full bg-purple-100 flex items-center justify-center">
                  <img src="../images/div (5).png" alt="" aria-hidden="true" />
                </div>
        ...
        <section className="relative bg-[#F9F5FF] py-18 overflow-hidden hidden lg:block">
          <div className="max-w-6xl mx-auto px-6 text-center">
            ...
            <p className="mt-6 max-w-[720px] mx-auto text-[16px] leading-[26px] font-readex text-[#6B6B6B]">
              We collaborate with skilled manufacturers and artisans across
              India to bring you authentic sarees that celebrate regional
        ...
        <section className="bg-white">
          <div className="relative w-full">
            <img src="../images/Group (10).png" alt="" aria-hidden="true" />
      ...
      "
              ...
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <p className="mt-3 max-w-[420px] font-readex text-[14px] leading-[22px] text-white/80">
                  Experience House of Priya in person at our upcoming boutique
                  in RS Puram, Coimbatore.
                </p>
                <form
      ...
      ${errors.email ? "border-red-500" : "border-gray-200"}`}
        ...
        <section className="relative bg-[#E5E7EB] py-20">
          <div className="max-w-5xl mx-auto  text-center">
            {/* QUOTE ICON */}
            <div className="text-[#6D28D9] text-[80px] lg:text-[100px] leading-[70px] md:leading-[90px] sm:text-[50px] lg:text-[85px]">
              “
            </div>
            ...
            <p className="font-gabriola font-normal text-[30px] md:text-[40px] lg:text-[45px] leading-[49px] tracking-[-0.5px] text-center text-[#5B2D8B]">
              Every saree at House of Priya is designed to feel personal,
              elegant, and timeless — just like the women who wear them.
            </p>
          </div>
          <img
